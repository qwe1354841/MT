...
--副本存在时间（分）
RenGuiJueLianConfig.ContinueTime = 60

--活动跳转点
RenGuiJueLianConfig.EnterPos = {"长安城", 504, 143, 0,"80副本-引导"}

--退出点
RenGuiJueLianConfig.QuitPos = {"长安城", 504, 143, 4}

--参加次数上限
RenGuiJueLianConfig.JoinMax = 1

--单张地图获得活跃值
RenGuiJueLianConfig.ActiveAddNum = 10

--活跃值上限
RenGuiJueLianConfig.ActiveMax = 10

--Dungeon描述
RenGuiJueLianConfig.ShowDesc = "长安城里有一位神秘的青年在求人帮助，似乎是遇到了什么不得了的难题，赶紧去帮帮他吧！"

--Dungeon背景图
RenGuiJueLianConfig.ShowPic = "1800600770"

--地图表 流程表
RenGuiJueLianConfig.MapConfig = {
	[1] = {
		["MapKeyName"] = "80副本-酆都", 
		["BornPoint"] = {144, 98, 0},
		["Step_0"] = {
			...
			Trace = {Desc = "帮助地府鬼将击败$Aim1。", QuestMode = "Fight", QuestAim = "80副本-捣乱的鬼魂"},
			--AddTips = {Message = "---傲来村畔守匪迹---", Color="#FFD700FF"}, --颜色RGBA
			AddNPC = {
				{KeyName = "80副本-地府鬼将1", X = 120 , Y = 102, Range = 0, Direction = 3, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
				{KeyName = "80副本-地府鬼将2", X = 115 , Y = 108, Range = 0, Direction = 3, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
				{KeyName = "80副本-捣乱的鬼魂", X = 134 , Y = 109, Range = 0, Direction = 3, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
				{KeyName = "80副本-黑无常", X = 38 , Y = 36, Range = 0, Direction = 3, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
				{KeyName = "80副本-白无常", X = 48 , Y = 32, Range = 0, Direction = 3, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
				{KeyName = "80副本-孟婆", X = 25 , Y = 113, Range = 0, Direction = 3, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
				{KeyName = "80副本-恶鬼", X = 31 , Y = 111, Range = 0, Direction = 3, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
			}
		},
		["Step_1"] = {
			ShowStep = 0,
			Trace = {Desc = "击败了捣乱的鬼魂，赶紧问问附近的$Aim1是什么情况。", QuestMode = "Talk", QuestAim = "80副本-地府鬼将1"},
		},
		["Step_2"] = {
			ShowStep = 1,
			Trace = {Desc = "找$Aim1问问，黑白无常在哪里。", QuestMode = "Talk", QuestAim = "80副本-孟婆"},
			--AddTips = {Message = "---湖畔激战知匪计---", Color="#FFD700FF"}, 
		},
		["Step_3"] = {
			ShowStep = 0,
			Trace = {Desc = "帮助孟婆击败$Aim1。", QuestMode = "Fight", QuestAim = "80副本-恶鬼"},
			--AddTips = {Message = "---傲来药店知匪踪---", Color="#FFD700FF"}, 
		},
		["Step_4"] = {
			ShowStep = 1,
			Trace = {Desc = "击败了恶鬼，赶紧再去找$Aim1问问黑白无常在哪里吧。", QuestMode = "Talk", QuestAim = "80副本-孟婆"},
			DelNPC = {
				{KeyName = "80副本-恶鬼", Del_Num = -1},--  全删 -1
			},
		},
		["Step_5"] = {
			ShowStep = 0,
			Trace = {Desc = "去中央大殿找$Aim1了解下情况。", QuestMode = "Fight", QuestAim = "80副本-黑无常"},
		},
		["Step_6"] = {
			ShowStep = 0,
			Trace = {Desc = "黑无常似乎还没有冷静下来，找他的妹妹$Aim1谈谈。", QuestMode = "Talk", QuestAim = "80副本-白无常"},
	...
	[2] = {
		...
		["Step_0"] = {
			["Movie"] = "90817", 
			ShowStep = 1,
			Trace = {Desc = "击败拦路的$Aim1。", QuestMode = "Fight", QuestAim = "80副本-女尸怨灵"},
			AddNPC = {
				{KeyName = "80副本-青年妻子", X = 196 , Y = 52, Range = 0, Direction = 4, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
				{KeyName = "80副本-千年女妖", X = 206 , Y = 51, Range = 0, Direction = 4, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
				{KeyName = "80副本-女尸怨灵", X = 155 , Y = 86, Range = 0, Direction = 4, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
			},
		},
		["Step_1"] = {
			["Movie"] = "90815", 
			ShowStep = 1,
			Trace = {Desc = "赶紧去山顶，$Aim1应该就在那里！", QuestMode = "Talk", QuestAim = "80副本-青年妻子"},
			DelNPC = {
				{KeyName = "80副本-女尸怨灵", Del_Num = -1},--  全删 -1
			},
		},
		["Step_2"] = {
			ShowStep = 0,
			Trace = {Desc = "击败$Aim1。她很强大，千万不要大意！", QuestMode = "Fight", QuestAim = "80副本-千年女妖"},
		},
		["Step_3"] = {
			["Movie"] = "90816", 
			ShowStep = 1,
			Trace = {Desc = "恭喜你们，通关人鬼绝恋副本！", QuestMode = "Talk", QuestAim = "80副本-黑无常结束"},
			AddNPC = {
				{KeyName = "80副本-黑无常结束", X = 196 , Y = 63, Range = 0, Direction = 4, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
				{KeyName = "80副本-白无常结束", X = 188 , Y = 58, Range = 0, Direction = 4, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
			},
			DelNPC = {
				{KeyName = "80副本-青年妻子", Del_Num = -1},--  全删 -1
			},
		},
	},
}
	...
	[2] = {
		...
		["Step_1"] = {
			["80副本-青年妻子"] = {
				...
				["Talk_2"] = {
					["TalkMsg"] = {Msg = "*NPC*80副本-千年女妖*哦呵呵，你还真是有个痴情的相公呢，看得奴家好生羡慕啊~", NextTalk = -1 , NextStep = -1}, 
					["Option"] = {
						[1] = {Msg = "*None*", NextTalk = 3, NextStep = -1, StartFight = -1, NextFloor = -1,}, 
					},
				},
				...
				["Talk_4"] = {
					["TalkMsg"] = {Msg = "*NPC*80副本-千年女妖*还真是一对苦命的鸳鸯啊~看的奴家都不忍心拆散你们了~", NextTalk = -1 , NextStep = -1}, 
					["Option"] = {
						[1] = {Msg = "*None*", NextTalk = 5, NextStep = -1, StartFight = -1, NextFloor = -1,}, 
					},
				},
				["Talk_5"] = {
					["TalkMsg"] = {Msg = "*NPC*80副本-黑无常结束*！！！", NextTalk = -1 , NextStep = -1}, 
					["Option"] = {
						[1] = {Msg = "*None*", NextTalk = 6, NextStep = -1, StartFight = -1, NextFloor = -1,}, 
					},
				},
				["Talk_6"] = {
					["TalkMsg"] = {Msg = "*NPC*80副本-黑无常结束*千年女妖！你不是被封印了吗！", NextTalk = -1 , NextStep = -1}, 
					["Option"] = {
						[1] = {Msg = "*None*", NextTalk = 7, NextStep = -1, StartFight = -1, NextFloor = -1,}, 
					},
				},
				["Talk_7"] = {
					["TalkMsg"] = {Msg = "*NPC*80副本-千年女妖*是呀是呀，奴家可是被封印了千年之久呢~要不是这位少侠在水帘洞窟乱来，奴家可不知道要什么时候才能出来呢~", NextTalk = -1 , NextStep = -1}, 
					["Option"] = {
						[1] = {Msg = "*None*", NextTalk = 8, NextStep = -1, StartFight = -1, NextFloor = -1,}, 
					},
				},
				["Talk_8"] = {
					["TalkMsg"] = {Msg = "*NPC*80副本-千年女妖*正好奴家刚刚解封，缺少阳气。既然你们来了，就把你们的阳气都给奴家吧，好不好嘛~", NextTalk = -1 , NextStep = -1}, 
					["Option"] = {
						[1] = {Msg = "*None*", NextTalk = -1, NextStep = 2, StartFight = -1, NextFloor = -1,}, 
					},
				},
...
--活动展示用
RenGuiJueLianConfig.ShowItem = "28016,28017,61024,61025"


--进度/NPC奖励表  怪物npc打完给 宝箱直接给
RenGuiJueLianConfig.RewardConfig = {
	--  默认奖励表
	["通用默认奖励配置表"] = {
		['Exp'] = "0",
		['PetExp'] = "0",
	...
	["2_Step_2"] ={
		...
		['Item'] = {"化蝶青年的遗物", 1, 1},
		['RandItemList']={
			{ItemKey = "Nil", Num = 1, Bind = 0, Rand = 9190},
			{ItemKey = "酆都60天赋1", Num = 1, Bind = 0, Rand = 45},
			{ItemKey = "酆都60天赋2", Num = 1, Bind = 0, Rand = 45},
			{ItemKey = "酆都60天赋3", Num = 1, Bind = 0, Rand = 45},
			{ItemKey = "花果山60天赋1", Num = 1, Bind = 0, Rand = 45},
			{ItemKey = "花果山60天赋2", Num = 1, Bind = 0, Rand = 45},
			{ItemKey = "花果山60天赋3", Num = 1, Bind = 0, Rand = 45},
			{ItemKey = "慈恩寺60天赋1", Num = 1, Bind = 0, Rand = 45},
			{ItemKey = "慈恩寺60天赋2", Num = 1, Bind = 0, Rand = 45},
			{ItemKey = "慈恩寺60天赋3", Num = 1, Bind = 0, Rand = 45},
			{ItemKey = "流沙界60天赋1", Num = 1, Bind = 0, Rand = 45},
			{ItemKey = "流沙界60天赋2", Num = 1, Bind = 0, Rand = 45},
			{ItemKey = "流沙界60天赋3", Num = 1, Bind = 0, Rand = 45},
			{ItemKey = "西海龙宫60天赋1", Num = 1, Bind = 0, Rand = 45},
			{ItemKey = "西海龙宫60天赋2", Num = 1, Bind = 0, Rand = 45},
			{ItemKey = "西海龙宫60天赋3", Num = 1, Bind = 0, Rand = 45},
			{ItemKey = "净坛禅院60天赋1", Num = 1, Bind = 0, Rand = 45},
			{ItemKey = "净坛禅院60天赋2", Num = 1, Bind = 0, Rand = 45},
			{ItemKey = "净坛禅院60天赋3", Num = 1, Bind = 0, Rand = 45},
		},
	},
