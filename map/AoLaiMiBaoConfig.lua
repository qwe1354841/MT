...
--副本存在时间（分）
AoLaiMiBaoConfig.ContinueTime = 60

--活动跳转点
AoLaiMiBaoConfig.EnterPos = {"傲来村", 12, 118, 10,"45副本0"}

--退出点
AoLaiMiBaoConfig.QuitPos = {"傲来村", 21, 120, 10}

--参加次数上限
AoLaiMiBaoConfig.JoinMax = 1

--单张地图获得活跃值
AoLaiMiBaoConfig.ActiveAddNum = 10

--活跃值上限
AoLaiMiBaoConfig.ActiveMax = 10

--Dungeon描述
AoLaiMiBaoConfig.ShowDesc = "听说傲来村因为藏有一个惊天的大秘密，已经被一帮山贼盯上了，快去帮他们守住传说中的宝藏！"

--Dungeon背景图
AoLaiMiBaoConfig.ShowPic = "1800600740"

--地图表 流程表
AoLaiMiBaoConfig.MapConfig = {
	[1] = {
		["MapKeyName"] = "45副本", 
		["BornPoint"] = {148, 149, 4},
		["Step_0"] = {
			...
			Trace = {Desc = "击败准备登岸的$Aim1，让他们看看你的厉害。", QuestMode = "Fight", QuestAim = "45副本1"},
			AddTips = {Message = "---傲来村畔守匪迹---", Color="#FFD700FF"}, --颜色RGBA
			AddNPC = {
				{KeyName = "45副本1", X = 139 , Y = 154, Range = 0, Direction = 0, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
				{KeyName = "45副本-药品商店", X = 51 , Y = 119, Range = 0, Direction = 3, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
				{KeyName = "45副本-宠物商店", X = 104 , Y = 42, Range = 0, Direction = 4, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
				{KeyName = "45副本-武器商店", X = 186 , Y = 125, Range = 0, Direction = 3, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
				{KeyName = "45副本-装备商店", X = 152 , Y = 93, Range = 0, Direction = 5, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
				{KeyName = "45副本-杂货商店", X = 103 , Y = 139, Range = 0, Direction = 3, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
				{KeyName = "45副本-饰品商店", X = 59 , Y = 31, Range = 0, Direction = 5, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
			}
		},
		["Step_1"] = {
			ShowStep = 0,
			Trace = {Desc = "成功击溃登陆的强盗，看看手下败将$Aim1还有什么好说的。", QuestMode = "Talk", QuestAim = "45副本1"},
		},
		["Step_2"] = {
			["Movie"] = "90805",
			ShowStep = 1,
			Trace = {Desc = "赶紧去西南面看看，那边似乎也有$Aim1登岸了。", QuestMode = "Fight", QuestAim = "45副本2"},
			AddTips = {Message = "---湖畔激战知匪计---", Color="#FFD700FF"}, 
			DelNPC = {
				{KeyName = "45副本1", Del_Num = -1},--  全删 -1
			},
			AddNPC = {
				{KeyName = "45副本2", X = 38 , Y = 150, Range = 0, Direction = 2, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
			}
		},
		["Step_3"] = {
			ShowStep = 0,
			Trace = {Desc = "逼问$Aim1说出行动计划。", QuestMode = "Talk", QuestAim = "45副本2"},
		},
		["Step_4"] = {
			["Movie"] = "90806",
			ShowStep = 1,
			Trace = {Desc = "去找附近的$Aim1问问有没有看到其他强盗。", QuestMode = "Talk", QuestAim = "45副本-药品商店"},
			AddTips = {Message = "---傲来药店知匪踪---", Color="#FFD700FF"}, 
			DelNPC = {
				{KeyName = "45副本2", Del_Num = -1},--  全删 -1
			},
		},
		["Step_5"] = {
			ShowStep = 0,
			Trace = {Desc = "老爷子说$Aim1往北面去了，去会会他们。", QuestMode = "Fight", QuestAim = "45副本3"},
			AddNPC = {
				{KeyName = "45副本3", X = 63 , Y = 83, Range = 0, Direction = 4, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
			}
		},
		["Step_6"] = {
			ShowStep = 0,
			Trace = {Desc = "追问$Aim1其他强盗的下落。", QuestMode = "Talk", QuestAim = "45副本3"},
		},
		["Step_7"] = {
			["Movie"] = "90807",
			ShowStep = 1,
			Trace = {Desc = "去另一半看看，有没有$Aim1把守。", QuestMode = "Fight", QuestAim = "45副本4"},
			AddTips = {Message = "---调虎离山破匪阵---", Color="#FFD700FF"}, 
			DelNPC = {
				{KeyName = "45副本3", Del_Num = -1},--  全删 -1
			},
			AddNPC = {
				{KeyName = "45副本4", X = 135 , Y = 91, Range = 0, Direction = 4, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
			}
		},
		["Step_8"] = {
			["Movie"] = "90808",
			ShowStep = 1,
			Trace = {Desc = "差一点就让他把信号发出去了。饰品店传来求救声，快去看看$Aim1！", QuestMode = "Fight", QuestAim = "45副本-饰品商店"},
			AddTips = {Message = "---傲来剿匪助烟儿---", Color="#FFD700FF"}, 
		},
		["Step_9"] = {
			ShowStep = 0,
			Trace = {Desc = "附近篝火旁的$Aim1似乎被强盗抓住了，快去看看吧！", QuestMode = "Talk", QuestAim = "45副本-宠物商店"},
			AddNPC = {
				{KeyName = "45副本5", X = 118 , Y = 46, Range = 0, Direction = 5, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
			},
		},
		["Step_20"] = {
			ShowStep = 0,
			Trace = {Desc = "收下陆烟儿的谢礼$Aim1。", QuestMode = "Open", QuestAim = "45副本宝箱1"},
			AddNPC = {
				{KeyName = "45副本宝箱1", X = 48 , Y = 33, Range = 0, Direction = 4, Move = 0, Add_Num = 1, Min_Num = 0, Type = "Box"},
			},
			DelNPC = {
				{KeyName = "45副本-饰品商店", Del_Num = -1},--  全删 -1
			},
		},
		["Step_21"] = {
			ShowStep = 0,
		...
		["Step_10"] = {
			ShowStep = 1,
			Trace = {Desc = "替傲来村民击败$Aim1！", QuestMode = "Fight", QuestAim = "45副本5"},
		...
		["Step_11"] = {
			ShowStep = 0,
			Trace = {Desc = "找$Aim1问问，这群强盗到底为什么而来。", QuestMode = "Talk", QuestAim = "45副本-宠物商店"},
		},
		["Step_12"] = {
			ShowStep = 1,
			Trace = {Desc = "听苏卿酒说$Aim1似乎往东北面花果山的方向去了，快去看看。", QuestMode = "Fight", QuestAim = "45副本6"},
			AddTips = {Message = "---流水潺边斗首领---", Color="#FFD700FF"}, 
			AddNPC = {
				{KeyName = "45副本6", X = 191 , Y = 23, Range = 0, Direction = 5, Move = 0, Add_Num = 1, Min_Num = 0, Type = "NPC"},
			},
			DelNPC = {
				{KeyName = "45副本5", Del_Num = -1},--  全删 -1
			},
		},
		["Step_13"] = {
			["Movie"] = "90804",
			ShowStep = 1,
			Trace = {Desc = "恭喜你们，通关傲来秘宝副本！", QuestMode = "Talk", QuestAim = "45副本6"},
		},
	},
}

--NPC配置表
AoLaiMiBaoConfig.NPCConfig = {
	["45副本1"] = {
		["MonID"] = 1501,
	...
	[1] = {
		...
		["Step_9"] = {
			...
			["45副本-宠物商店"] = {
				...
				["Talk_3"] = {
					["TalkMsg"] = {Msg = "*NPC*45副本5*小娘们！你不要敬酒不吃吃罚酒！", NextTalk = -1 , NextStep = -1}, 
					["Option"] = {
						[1] = {Msg = "*None*", NextTalk = 4, NextStep = -1, StartFight = -1, NextFloor = -1,}, 
					},
				},
				["Talk_4"] = {
					["TalkMsg"] = {Msg = "*NPC*45副本5*我大哥脾气好，不打女人，不代表老二我没办法对付你！", NextTalk = -1 , NextStep = -1}, 
					["Option"] = {
						[1] = {Msg = "*None*", NextTalk = 5, NextStep = -1, StartFight = -1, NextFloor = -1,}, 
					},
				},
				...
				["Talk_6"] = {
					["TalkMsg"] = {Msg = "*NPC*45副本5*你他娘的又是谁啊！少TMD多管闲事！", NextTalk = -1 , NextStep = -1}, 
					["Option"] = {
						[1] = {Msg = "*None*", NextTalk = 7, NextStep = -1, StartFight = -1, NextFloor = -1,}, 
					},
				},
		...
		["Step_11"] = {
			["45副本-宠物商店"] = {
				...
				["Talk_6"] = {
					["TalkMsg"] = {Msg = "*NPC*45副本5*哼，你休想骗我们！我们老大推算出傲来村有三宝！就肯定有！更何况那几个傲来村的商人都说似乎见过！", NextTalk = -1 , NextStep = -1}, 
					["Option"] = {
						[1] = {Msg = "*None*", NextTalk = 7, NextStep = -1, StartFight = -1, NextFloor = -1,}, 
					},
				},
...
--活动展示用
AoLaiMiBaoConfig.ShowItem = "28011,28012,61024,61025" 


--进度/NPC奖励表  怪物npc打完给 宝箱直接给
AoLaiMiBaoConfig.RewardConfig = {
	--  默认奖励表
	["通用默认奖励配置表"] = {
		['Exp'] = "0",
		["PetExp"] = "0",
	...
	["1_Step_5"] ={
		...
		['Item'] = {},
		['RandItemList']={
			{ItemKey = "Nil", Num = 1, Bind = 0, Rand = 9640},
			{ItemKey = "花果山60天赋1", Num = 1, Bind = 0, Rand = 20},
			{ItemKey = "花果山60天赋2", Num = 1, Bind = 0, Rand = 20},
			{ItemKey = "花果山60天赋3", Num = 1, Bind = 0, Rand = 20},
			{ItemKey = "西海龙宫60天赋1", Num = 1, Bind = 0, Rand = 20},
			{ItemKey = "西海龙宫60天赋2", Num = 1, Bind = 0, Rand = 20},
			{ItemKey = "西海龙宫60天赋3", Num = 1, Bind = 0, Rand = 20},
			{ItemKey = "慈恩寺60天赋1", Num = 1, Bind = 0, Rand = 20},
			{ItemKey = "慈恩寺60天赋2", Num = 1, Bind = 0, Rand = 20},
			{ItemKey = "慈恩寺60天赋3", Num = 1, Bind = 0, Rand = 20},
			{ItemKey = "流沙界60天赋1", Num = 1, Bind = 0, Rand = 20},
			{ItemKey = "流沙界60天赋2", Num = 1, Bind = 0, Rand = 20},
			{ItemKey = "流沙界60天赋3", Num = 1, Bind = 0, Rand = 20},
			{ItemKey = "净坛禅院60天赋1", Num = 1, Bind = 0, Rand = 20},
			{ItemKey = "净坛禅院60天赋2", Num = 1, Bind = 0, Rand = 20},
			{ItemKey = "净坛禅院60天赋3", Num = 1, Bind = 0, Rand = 20},
			{ItemKey = "酆都60天赋1", Num = 1, Bind = 0, Rand = 20},
			{ItemKey = "酆都60天赋2", Num = 1, Bind = 0, Rand = 20},
			{ItemKey = "酆都60天赋3", Num = 1, Bind = 0, Rand = 20},
		},
	},
	...
	["1_Step_7"] ={
		...
		['Item'] = {"山贼的袋子", 1, 1},
		['RandItemList']={
			{ItemKey = "Nil", Num = 1, Bind = 0, Rand = 9514},
			{ItemKey = "花果山60天赋1", Num = 1, Bind = 0, Rand = 27},
			{ItemKey = "花果山60天赋2", Num = 1, Bind = 0, Rand = 27},
			{ItemKey = "花果山60天赋3", Num = 1, Bind = 0, Rand = 27},
			{ItemKey = "西海龙宫60天赋1", Num = 1, Bind = 0, Rand = 27},
			{ItemKey = "西海龙宫60天赋2", Num = 1, Bind = 0, Rand = 27},
			{ItemKey = "西海龙宫60天赋3", Num = 1, Bind = 0, Rand = 27},
			{ItemKey = "慈恩寺60天赋1", Num = 1, Bind = 0, Rand = 27},
			{ItemKey = "慈恩寺60天赋2", Num = 1, Bind = 0, Rand = 27},
			{ItemKey = "慈恩寺60天赋3", Num = 1, Bind = 0, Rand = 27},
			{ItemKey = "流沙界60天赋1", Num = 1, Bind = 0, Rand = 27},
			{ItemKey = "流沙界60天赋2", Num = 1, Bind = 0, Rand = 27},
			{ItemKey = "流沙界60天赋3", Num = 1, Bind = 0, Rand = 27},
			{ItemKey = "净坛禅院60天赋1", Num = 1, Bind = 0, Rand = 27},
			{ItemKey = "净坛禅院60天赋2", Num = 1, Bind = 0, Rand = 27},
			{ItemKey = "净坛禅院60天赋3", Num = 1, Bind = 0, Rand = 27},
			{ItemKey = "酆都60天赋1", Num = 1, Bind = 0, Rand = 27},
			{ItemKey = "酆都60天赋2", Num = 1, Bind = 0, Rand = 27},
			{ItemKey = "酆都60天赋3", Num = 1, Bind = 0, Rand = 27},
		},
	},
	...
	["1_Step_10"] ={
		...
		['Item'] = {"山贼的袋子", 1, 1},
		['RandItemList']={
			{ItemKey = "Nil", Num = 1, Bind = 0, Rand = 9298},
			{ItemKey = "花果山60天赋1", Num = 1, Bind = 0, Rand = 39},
			{ItemKey = "花果山60天赋2", Num = 1, Bind = 0, Rand = 39},
			{ItemKey = "花果山60天赋3", Num = 1, Bind = 0, Rand = 39},
			{ItemKey = "西海龙宫60天赋1", Num = 1, Bind = 0, Rand = 39},
			{ItemKey = "西海龙宫60天赋2", Num = 1, Bind = 0, Rand = 39},
			{ItemKey = "西海龙宫60天赋3", Num = 1, Bind = 0, Rand = 39},
			{ItemKey = "慈恩寺60天赋1", Num = 1, Bind = 0, Rand = 39},
			{ItemKey = "慈恩寺60天赋2", Num = 1, Bind = 0, Rand = 39},
			{ItemKey = "慈恩寺60天赋3", Num = 1, Bind = 0, Rand = 39},
			{ItemKey = "流沙界60天赋1", Num = 1, Bind = 0, Rand = 39},
			{ItemKey = "流沙界60天赋2", Num = 1, Bind = 0, Rand = 39},
			{ItemKey = "流沙界60天赋3", Num = 1, Bind = 0, Rand = 39},
			{ItemKey = "净坛禅院60天赋1", Num = 1, Bind = 0, Rand = 39},
			{ItemKey = "净坛禅院60天赋2", Num = 1, Bind = 0, Rand = 39},
			{ItemKey = "净坛禅院60天赋3", Num = 1, Bind = 0, Rand = 39},
			{ItemKey = "酆都60天赋1", Num = 1, Bind = 0, Rand = 39},
			{ItemKey = "酆都60天赋2", Num = 1, Bind = 0, Rand = 39},
			{ItemKey = "酆都60天赋3", Num = 1, Bind = 0, Rand = 39},
		},
	},
	...
	["1_Step_12"] ={
		...
		['Item'] = {"大当家的收藏", 1, 1},
		['RandItemList']={
			{ItemKey = "Nil", Num = 1, Bind = 0, Rand = 8290},
			{ItemKey = "花果山60天赋1", Num = 1, Bind = 0, Rand = 95},
			{ItemKey = "花果山60天赋2", Num = 1, Bind = 0, Rand = 95},
			{ItemKey = "花果山60天赋3", Num = 1, Bind = 0, Rand = 95},
			{ItemKey = "西海龙宫60天赋1", Num = 1, Bind = 0, Rand = 95},
			{ItemKey = "西海龙宫60天赋2", Num = 1, Bind = 0, Rand = 95},
			{ItemKey = "西海龙宫60天赋3", Num = 1, Bind = 0, Rand = 95},
			{ItemKey = "慈恩寺60天赋1", Num = 1, Bind = 0, Rand = 95},
			{ItemKey = "慈恩寺60天赋2", Num = 1, Bind = 0, Rand = 95},
			{ItemKey = "慈恩寺60天赋3", Num = 1, Bind = 0, Rand = 95},
			{ItemKey = "流沙界60天赋1", Num = 1, Bind = 0, Rand = 95},
			{ItemKey = "流沙界60天赋2", Num = 1, Bind = 0, Rand = 95},
			{ItemKey = "流沙界60天赋3", Num = 1, Bind = 0, Rand = 95},
			{ItemKey = "净坛禅院60天赋1", Num = 1, Bind = 0, Rand = 95},
			{ItemKey = "净坛禅院60天赋2", Num = 1, Bind = 0, Rand = 95},
			{ItemKey = "净坛禅院60天赋3", Num = 1, Bind = 0, Rand = 95},
			{ItemKey = "酆都60天赋1", Num = 1, Bind = 0, Rand = 95},
			{ItemKey = "酆都60天赋2", Num = 1, Bind = 0, Rand = 95},
			{ItemKey = "酆都60天赋3", Num = 1, Bind = 0, Rand = 95},
		},
	},
